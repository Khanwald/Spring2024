public class tester {
	...
	public static void main(String[] args) {
		...
		quotientReminder(28,7);
		quotientReminder(-28, 7);
		quotientReminder(31, 7);
		quotientReminder(-31, 7);
		quotientReminder(0,6);
		quotientReminder(5, 6);
		quotientReminder(-5, 6);
		quotientReminder(-10, 6);
	}
	...
	public static void quotientReminder(int n, int d){
		...
		// n is negative
			...
			//TO DO
			int new_n = -n;
			if(-n > -(d * (n/d)) && n%d != 0){new_n = -n + d;}
			/*Stub*/ res = new qrResult(-new_n/d,(d * (new_n/d)) + n); /*Stub*/
